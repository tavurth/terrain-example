...
import TerrainShaderMaterial from './TerrainShaderMaterialOld'
...
class Terrain extends THREE.Object3D {
    constructor(options = {}) {
        ...
        options.uniforms.heightmap = options.heightmap;
        options.uniforms.texture = options.texture;

        if (! options.uniforms.heightmap && ! options.material.uniforms.heightmap) {
